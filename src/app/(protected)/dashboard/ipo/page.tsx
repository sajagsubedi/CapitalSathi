  ...
  return (
    <div className="p-4 sm:p-6 space-y-6">
      <div className="space-y-1">
        <h1 className="text-2xl font-semibold">IPO Holdings</h1>
        <p className="text-sm text-muted-foreground">
          Track your IPO allocations across portfolios
        </p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="text-sm font-medium">Total IPO Value</CardTitle>
          </CardHeader>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-base">Add IPO Holding</CardTitle>
        </CardHeader>
        ...
        <CardContent>
          {isLoading ? (
            ...
            <div className="text-sm text-muted-foreground">
              Create an IPO portfolio first in “Portfolios”.
            </div>
          ) : holdings.length === 0 ? (
            <div className="text-sm text-muted-foreground">No IPO holdings yet.</div>
          ) : (
